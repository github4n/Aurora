var $MB_Redis_Bash = function () {
    $(document).ready(function () {
        ...
        printf("Last login: " + date + " on aurora, type `help` for help\n");
        displayPrompt();
        ...
        function flushdb(args) {
            $.get("/redis/flushdb",{},function (r) {
                var data = r.msg;
                printf(data + "\n");
                printc();
            });
        ...
        function flushall(args) {
            $.get("/redis/flushall",{},function (r) {
                var data = r.msg;
                printf(data + "\n");
                printc();
            });
